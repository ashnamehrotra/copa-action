...
@test "Run trivy on patched image" {
    run DOCKER_HOST="$SOCKET" trivy image --exit-code 1 --vuln-type os --ignore-unfixed -f json -o opa.0.46.0-patched.json 'docker.io/openpolicyagent/opa:0.46.0-patched'
    [ "$status" -eq 0 ]
